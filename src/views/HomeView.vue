<template>
  ...
  <div class="bg-gray-200 min-h-screen text-white">
    ...
    <div
      class="text-gray-600 mx-20 italic text-md pt-5 font-medium text-center"
    >
      <p>
        I design, develop and deliver software product that takes cutting edge
        research in clean/renewable energy technologies directly to the
        Industry. I love the whole journey of taking research idea and
        delivering fully functioning software product helping humanity move
        towards clean future.
      </p>
    </div>
    ...
    <div class="flex items-center justify-center mt-5">
      ...
      <a href="https://linkedin.com/in/kapil-duwadi">
    ...
    <div
      class="flex flex-col justify-center items-center mt-5 text-md md:flex-row"
    >
      <button
        class="
          bg-indigo-600
        ...
        "
      >
        <a href="https://forms.gle/dsumB6cCgD3gHMER8" target="_blank">
          Let's talk
        </a>
      </button>
      <button
    ...
    >
      <div
        class="mb-10 border-t-2 hover:border-indigo-500"
    ...
    <div class="bg-indigo-600 border-t">
      <div class="mx-20">
        <p class="my-10 text-xl text-center">
          Companies I have collaborated with while at NREL
        </p>
        ...
        >
          <img
            class="opacity-75 rounded-md mb-10"
            src="images/smud.png"
            height="50"
            width="150"
          />
          <img
            class="opacity-75 rounded-md mb-10"
            src="images/utilidata.png"
            height="50"
            width="150"
          />
          <img
            class="opacity-75 rounded-md mb-10"
            src="images/ngrid.png"
            height="50"
            width="150"
          />
          <img
        ...
        <p class="text-md text-white font-bold text-center py-5">
          @kduwadi.com, 2022
        </p>
      </div>
    </div>
      ...
      projects: [
        {
          ...
          desc_url:
            "/projects/precise/description/processing-solar-application",
          tags: [
        ...
        },
        {
          ...
          desc_url: "/projects/emerge/description",
          tags: [
            { name: "Python", url: "https://www.python.org/" },
            { name: "DSS", url: "https://www.epri.com/pages/sa/opendss" },
        ...
        },
        {
          ...
          desc_url: "/projects/evolve/description",
          image: "images/evolve.svg",
          tags: [
            { name: "Python", url: "https://www.python.org/" },
            { name: "React", url: "https://reactjs.org/" },
            { name: "Solar", url: "https://www.nrel.gov/solar/" },
            {
              name: "EV",
              url: "https://www.nrel.gov/transportation/project-ev-grid-integration.html",
            },
            { name: "Storage", url: "https://www.nrel.gov/storage/" },
          ],
        },
        {
          name: "Effort",
          desc_url: "/projects/effort/description",
        ...
        {
          name: "Shift",
          desc_url: "/projects/shift/description",
